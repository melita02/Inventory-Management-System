		...
		<select>
    		...
    		<option value="H&M">H&M</option>
						...
						<li>	
							...
							<input id="slct2" name="slct2" class="field-style">
								</option>
    						</input>
						</li>	
						<li>	
...
if($c<=20)
{
  ...
  $ins="INSERT INTO orders(Item,Supplier,Color,Size,Quantity) VALUES ('".$i."','".$sa."','".$j."','".$k."',".$vinu.")";
     $insertion=mysqli_query($conn,$ins);

     $msg="Order is been place for ".$i." ";
     echo"<script type='text/javascript'>alert('$msg');</script> ";

    $inssup="INSERT INTO sorder (Iname,Quantity,Size) VALUES ('".$i."','".$vinu."','".$k."')";
     $insertionsup=mysqli_query($conn,$inssup);
